...
cause = ['Caught in or between','Human Error', 'Fall (from elevation)', 'Struck-by', 'Card-vascular/resp. fail.', 'Shock', 'Struck against', 'Inhalation',
...
font = ('times', 16, 'bold')
title = Label(main, text='CONSTRUCTION SITE ANALYSIS FOR ACCIDENTS')
title.config(bg='red', fg='black',anchor=CENTER)  
title.config(font=font)           
title.config(height=3, width=128)       
title.place(x=0,y=8)
